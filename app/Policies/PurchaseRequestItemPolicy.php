...
class PurchaseRequestItemPolicy
{
     ...
     */
    public function restore(User $user, PurchaseRequestItem $purchaseRequestItem): bool
    {
        return false;
    }
     ...
     */
    public function forceDelete(User $user, PurchaseRequestItem $purchaseRequestItem): bool
    {
        return false;
    }
}
